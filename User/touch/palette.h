...
typedef struct 
{
  ...
  void (*draw_btn)(void * btn);     //按键描绘函数 Draw_Color_Button, Draw_Clear_Button, Draw_Shape_Button
  void (*btn_command)(void * btn);  //按键功能执行函数，例如切换颜色、画刷 Command_Select_Color, Command_Clear_Palette, Command_Select_Brush
