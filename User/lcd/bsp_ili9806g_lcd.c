...
void ILI9806G_Fill_Colors_To_Area(uint16_t usX, uint16_t usY, uint16_t usWidth, uint16_t usHeight, uint16_t* usColor)
{
	uint32_t i = 0;
...
void ILI9806G_Draw_Point( uint16_t usX, uint16_t usY, uint16_t usColor )
{
	LCD_SetTextColor(usColor);
	ILI9806G_SetPointPixel(usX, usY);
}
